...
// Solver functions
void mpi_applyJacobi(gridLevel* g, size_t l, size_t relaxations, int xdim, int dim, int xcoord, int ycoord, int left, int right, int top, int bottom, MPI_Comm comm);
