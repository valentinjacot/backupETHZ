...
int main(int argc, char* argv[])
{
	...
	*/
	...
	Korali::Parameter::Uniform y1("y1", 0.0, +1);
	...
	Korali::Parameter::Uniform y2("y2", 0.0, +1);
	...
	Korali::Parameter::Uniform y3("y3", 0.0, +1.0);
	...
	Korali::Parameter::Uniform y4("y4", 0.0, +1.0);
	...
	solver.setPopulationSize(8); // ~4+3*log(N) For exercise 4, =24
	solver.setMu(4);// =: PopSize/2 For exercise 4, =12
