...
{ 
  ...
  Korali::Parameter::Gaussian *psx1,* psx2, *psx3;
  ...
  switch( choice ){
    ...
    case 1:
            ...
            psx1 = new Korali::Parameter::Gaussian("PosX1",  0.5,  0.1);
            psx1->setBounds( 0.0, 1.0 );
    ...
    case 2:
            ...
            psx1 = new Korali::Parameter::Gaussian("PosX1",  0.25, 0.05);
            psx1->setBounds( 0.0, 1.0 );
            psy1 = new Korali::Parameter::Uniform( "PosY1",  0.0,  1.0);
            ...
            psx2 = new Korali::Parameter::Gaussian("PosX2",  0.75, 0.05);
            psx2->setBounds( 0.0, 1.0 );
  ...
  // 3 candles
    case 3:
            ...
            psx3 = new Korali::Parameter::Gaussian("PosX3",  0.75, 0.05);
            psx3->setBounds( 0.0, 1.0 );
