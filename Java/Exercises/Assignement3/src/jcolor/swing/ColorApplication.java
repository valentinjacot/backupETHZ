...
class ColorApplication extends JFrame {
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				JFrame f = new ColorApplication();
				f.pack();
				f.setVisible(true);
			}
		});
	...
	// Color model;
	ColorApplication() {
		super("Color Picker Application 2");
		...
		attr.add(new ColorMenuItem(model,"yellow", Color.yellow));
